...
/********************getCustomerData*******************************************************************
    Purpose:
	Reads data from stdin (which is meant to have a file redirected into it), and sorts this data 
	into an the array of Customer structure pointers. 
    Parameters:
	I/O	Customer customerM[]	Array of Customer structure pointers to pass customer data into
	I	int *piNumCustomer	Integer pointer that lists the number of pointers to get from
					the Customer pointers
    Notes:
		-Must have stdio.h included in the program and "cs2123p0.h" included in the program too.
