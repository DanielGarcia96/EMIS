// Please create a comment header for this file

/******************************************************************************
cs2123p2Driver.c by Larry Clark
Purpose:
    This program reads graph data, creates a graph based on this data, computes information about it,
    and then prints the graph
Command Parameters:
    p6 < p6input.txt
Input:
    p6input.txt:
        Information needed to build the graph
Results:
	-Prints all relevant information about a graph except for a representation
Returns:
    0 - normal
Notes:
*******************************************************************************/
