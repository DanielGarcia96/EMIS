...
{
    char cLabel;
    int iMaxFromSource;	//TE
    int iMaxFromSink;
    int iTL;		//MAX TE - MAX DIST FROM SINK
...
void sortPathNodes(Graph graph, char szPathNodes[]);
...
int findHighestPath(Graph g, EdgeNode *list, char cType);

Vertex getVertex(Graph graph, char cKey);
