...
Results:
    ...
    For each query: 
        - print the query
        - print prefix representation of the query
        - print list the customers (IDs and names) of customers 
...
Returns:
    ...
    501 - boundary condition - too many customers
    502 - boundary condition - too many traits
    503 - bad input
...
Purpose:
    ...
    shows the customers that satisified the queries (via printQueryResult).   
Parameters:
...
Purpose:
    ...
    value).  If he doesn't, notany returns TRUE; otherwise, it 
    returns FALSE.
Parameters:
