      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			<li><a href="appointment2.php">Pending Appointments</a></li>
            <li class="active"><a href="#">Upcoming Appointments<span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">Upcoming Appointments</h2>
              ...
              <tbody>
                <?php
                  ...
                  if(isset($_SESSION['email'])){
                    ...
                    $query = "SELECT * FROM appointments WHERE status='Approved' ORDER BY start_time ASC";
