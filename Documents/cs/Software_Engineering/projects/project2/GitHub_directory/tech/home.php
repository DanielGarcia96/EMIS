...
<<<<<<< HEAD
			<li>
                <?php
                    ...
                    $id = $_SESSION["ID"];
                    echo "<a href=\"";
                    if($id == 3){//receptionist
                        echo "appointment2.php";
                    }elseif($id == 1){//doctor
                        echo "appointment3.php";
                    }else{//patient
